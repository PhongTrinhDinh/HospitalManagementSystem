...
// Hàm heapifyDown dùng để duy trì tính chất của heap nhỏ (min-heap) 
// bắt đầu từ vị trí index, đẩy phần tử tại index xuống đúng vị trí nếu cần thiết.
// Thường được gọi sau khi xóa phần tử gốc hoặc thay đổi giá trị tại một nút.
